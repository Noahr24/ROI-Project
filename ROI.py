...
class returnOnInvestment:
    ...
    def __init__(self, income = 0, expenses = 0, cash_flow = 0, cash_on_cash = 0):
        self.income = income
    ...
    def roiCashOnCash(self):
        ...
        self.cash_on_cash = down_payment + closing + rehab + additional
        return self.cash_on_cash


    # This method shows the final return on investment equation
    def roi(self):
        total_cash_flow = (self.income - self.expenses) * 12
        return f'{(total_cash_flow / self.cash_on_cash) * 100}%'
